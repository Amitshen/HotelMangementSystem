          ...
          <div class="col-sm-6">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <input type="email" value="<?php echo $result['email']; ?>" readonly="readonly" class="form-control" name="email" required />
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <input type="number" value="<?php echo $result['mobile']; ?>" readonly="readonly" class="form-control" name="phone" required>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <textarea name="address" class="form-control" readonly="readonly"><?php echo $result['address'];  ?></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" readonly="readonly" value="<?php echo $result['country']; ?>" name="city" required>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <input type="hidden" name="state" class="form-control"  required>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <input type="hidden" name="zip" class="form-control"  required>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-7">
                  ...
                  <div class="radio-inline"><input type="radio" value="twin" name="Occupancy" required>Dubble</div>

...
<footer style="background-color: #393939;">
  <div class="container-fluid">
    ...
    <div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Durga nagar, TYC phase 2, Agra</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>amit6t8@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91) 7079408013</p><br><br><br>
        ...
        <div class="panel-body">
          ...
          <div class="feedback">
            <form method="post"><br>
              ...
              <div class="form-group">
                <input type="Number" name="mob" class="form-control" id="#" placeholder="Enter Your Mobile" required>
              </div>
              <div class="form-group">
                <textarea type="Text" name="msg" class="form-control" id="#" placeholder="Type Your Massage" required></textarea>
              </div>
              <input type="submit" value="send" name="send" class="btn btn-success btn-group-justified" required>
            </form>
          </div>
        </div>
      </div>
...
<footer class="container-fluid text-center" style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Develope By Amit Shen | All Rights Reserved 2022</p>
</footer>
